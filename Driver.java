...
class Driver {
  ...
  public static void main(String[] args) {
	...
	try{
		...
		for (Float f : inp) {
			...
			System.out.println("Getting boundary edges");	
             ...
             ArrayPrinter.print(boundary_edges);           
			 break;
                    case "IS_CONNECTED":
			...
			ArrayPrinter.print(nbrs_of_point);
			 break;

                    case "NEIGHBORS_OF_TRIANGLE":
			System.out.println("FINDING NEIGHBORS_OF_TRIANGLE" );
			TriangleInterface[] data = shape_intr.NEIGHBORS_OF_TRIANGLE(input);
			ArrayPrinter.print(data);
			break;

                    case "INCIDENT_TRIANGLES":
			System.out.println("FINDING INCIDENT_TRIANGLES " );
			TriangleInterface[] data2 = shape_intr.INCIDENT_TRIANGLES(input);
			ArrayPrinter.print(data2);
			break;

                    case "VERTEX_NEIGHBOR_TRIANGLE":
			System.out.println("FINDING VERTEX_NEIGHBOR_TRIANGLE " );
			PointInterface[] data3 = shape_intr.VERTEX_NEIGHBOR_TRIANGLE(input);
            ArrayPrinter.print(data3);           	 
			break;
			...
			ArrayPrinter.print(extended_neighbor_triangle);
			break;
			...
			System.out.println(" Finding   EDGE_NEIGHBOR_TRIANGLE ");
             ...
             ArrayPrinter.print(edge_neighbors_of_triangle);           
			 break;
			...
			System.out.println(" Finding TRIANGLE_NEIGHBOR_OF_EDGE ");
			 ...
			 ArrayPrinter.print(triangle_neighbors);
			break;
			...
			ArrayPrinter.print(centroid_array);
                        break;
			...
			ArrayPrinter.print(closest_vertices);
			  break;
	...
	//long time_elapsed = System.nanoTime() - qstart;
	//System.out.println("TIME ELAPSED: " + time_elapsed/100000000);
